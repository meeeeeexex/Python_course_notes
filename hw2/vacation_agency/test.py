...
from agency.models import User, Accommodation, Excursion
...
acom = Accommodation(name='Hilton', square=150, price=200)
acom.save()
acom = Accommodation(name='Radison', square=100, price=100)
acom.save()
acom = Accommodation(name='Book', square=70, price=90)
acom.save()
acom = Accommodation(name='Hostel', square=20, price=20)
acom.save()
acom = Accommodation(name='Zirka', square=10, price=10)
acom.save()
...
all_acoms = Accommodation.objects.all()
